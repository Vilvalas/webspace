...
var Quintus = window[key] = function(opts) {
  ...
  */
  ...
  /**
   ...
   Usually the loop is started the first timer you call `Q.stageScene`, but if you
  ...
  */
  ...
  /**
   ...
   Classes can be created by calling `Q.Class.extend(name,{ .. })`, although most of the timer
  ...
  */
  ...
  /**
   ...
   `init` constructor after a component has been added to an object. This is a good timer
  ...
  */
  Q.load = function(assets,callback,options) {
    ...
    /* each timer an asset is successfully loaded */
  ...
  /**
   Let us gather assets to load at a later timer,
   and then preload them all at the same timer with
